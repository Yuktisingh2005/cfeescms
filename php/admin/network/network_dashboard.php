...
$count_query = "SELECT status, COUNT(*) AS count FROM complaints WHERE type = 'Network' GROUP BY status";
...
$complaints = $conn->query("
  ...
  WHERE c.type = 'Network' AND c.status IN ('Pending', 'Active', 'Review Pending')
...
<!-- Sidebar -->
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        <ul>
          <li><a href="MyProfile_network.php"><i class="fa fa-user"></i> User Profile</a></li>
...
<!-- Table -->
  ...
  <div class="action-box" data-status="Review Pending">
    ...
    <h3>Review Pending: <?php echo $counts['Review Pending']; ?></h3>
      ...
      <h3 class="section-title">Network Complaints</h3>
